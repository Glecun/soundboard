...
const ChooseSoundsPath = () => {
   ...
   const fileSelected = (event: BaseSyntheticEvent) => {
      ...
      if (file) {
         ...
         setUserPreferences(
            getUserPreferences().setPathToSoundsJson(file.path)
         );
      }
   }
   ...
   return (
      <div className="choose-sounds-path">
         <div className="input-container">
            ...
            <input type="file" className="input-file" accept='.json' onChange={fileSelected}/>
         </div>
         <span className="current-path">
            <span className="label">Current path: </span>{soundJsonPath}
         </span>
      </div>
   );
};
