...
import {getUserPreferences, setUserPreferences} from "../../domain/SoudboardDomain";
...
class OptionsDevice {
   ...
   static fromUserPreferences(userPreference: UserPreferences) : OptionsDevice{
      return new OptionsDevice({deviceId: userPreference.audioOutput.id, label: userPreference.audioOutput.name} as MediaDeviceInfo, userPreference.audioOutput.name);
   }
...
export const ChooseAudioOutput = () => {
   ...
   const [selectedOption, setSelectedOption] = useState(new OptionsDevice({label: "Default", deviceId:"default"} as MediaDeviceInfo, "Default"));
   ...
   const onSelect = (selectedOption: OptionsDevice) => {
      ...
      setUserPreferences(getUserPreferences().setAudioOutput(selectedOption.toAudioOutput()))
   }
